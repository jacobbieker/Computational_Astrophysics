...
def plot_outputs(only_direct_name, only_tree_name, combined_names):
    ...
    print(flipped_final_error.type)
...
"""
"""
Creating the inputs for plot_outputs()

"""
text_file = open('/disks/strw21/users/linsi/linsi/comp_astro/assignment_three/LOberhelman_Laptop/names.txt', "r")
mixed_ph4_bhtree = []
for line in text_file:
    mixed_ph4_bhtree.append(line.strip())
    
bh_tree_only = '/disks/strw21/users/linsi/linsi/comp_astro/assignment_three/LOberhelman_Laptop/Checkpoint_DC_None_TC_bhtree_ClusterMass_6958.06538623_Radius_3.0_Cut_6.0_Flip_False_Stars_10000_Timestep_100.0_EndTime_10.0.p'
ph4_only = '/disks/strw21/users/linsi/linsi/comp_astro/assignment_three/LOberhelman_Laptop/Checkpoint_DC_ph4_TC_None_ClusterMass_6958.06538623_Radius_3.0_Cut_6.0_Flip_False_Stars_10000_Timestep_100.0_EndTime_10.0.p'
